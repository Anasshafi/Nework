    ...
    return (
        <div className='border p-3 rounded-md shadow-md flex flex-col gap-4 cursor-pointer' onClick={
            ...
            <div className='flex items-center gap-3 cursor-pointer'>
                <div>
                    <img src="https://loremflickr.com/400/400" className="h-[4.5rem] w-[5rem] rounded-lg object-cover" />
                </div>
                <div className='flex flex-col gap-1'>
                    <h1 className=''>{props.title || 'Anas Shafi'}</h1>
                    <p className='text-xs text-[#7B7B7B] pointer' >{props.desc ||'Senior Android Developer'}</p>
                </div>
            </div>  
            ...
            <div className='flex items-center gap-3 flex-wrap'>
                {
                    props.projects ? props.projects.map((p,idx)=>(
                         <Button text={p} key={idx} className='border-[#579FAE] border font-semibold !py-1 text-sm !px-4 text-[#579FAE]' bg='bg-[#DBEEF2]' />
                    )) : <>
                    <Button text='25 Projects' className='border-[#579FAE] border font-semibold !py-1 text-sm !px-4 text-[#579FAE]' bg='bg-[#DBEEF2]' />
                    <Button text='1.5k Likes' className='border-[#579FAE] border font-semibold !py-1 text-sm !px-4 text-[#579FAE]' bg='bg-[#DBEEF2]' />
                    </>
                }
