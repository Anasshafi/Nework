...
const JobDetail = () => {
  let { id } = useParams();
  const { getJob } = UseJob();
  const { data: d } = swr("get-job-" + id, async () => await getJob(id));
  console.log("data = ", d);
            ...
            <div className="lg:col-span-4">
              <div className="flex flex-col gap-6">
                <div className="px-4 py-5 flex flex-col gap-3 border rounded-lg description-css">
                  <h1>About the Job</h1>
                  <p>
                    We are looking for an Android developer responsible for the
                    development and maintenance of applications aimed at a vast
                    number of diverse Android devices. Your primary focus will
                    be the development of Android applications and their
                    integration with back-end services. You will be working
                    along-side other engineers and developers working on
                    different layers of the infrastructure. Therefore,
                    commitment to collaborative problem solving, sophisticated
                  ...
                  <p className="cursor-pointer w-fit !text-[#248489]">
                    ---- See more
                  </p>
                </div>
                ...
                <div className="px-4 py-5 flex flex-col gap-3 border rounded-lg">
                  ...
                  <div>
                    <p className="text-[#7B7B7B] text-sm">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Voluptas velit possimus dolorum doloribus iusto eos
                      consequuntur hic sit quos, eligendi nisi animi, odio illum
                      deserunt placeat fuga vitae nam cumque suscipit sed beatae
                      dicta ad excepturi tempora. Cum saepe, mollitia debitis,
                      quidem neque corrupti explicabo at nesciunt, sint
                      dignissimos omnis?
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-6">
                    ...
                    return (
                      <div className="flex items-center gap-4">
                        <div>
                          <CircleIcon
                            size="3.6rem"
                            className="bg-[#F2F8FA] !rounded-2xl"
                          >
                            {item.icon}
                          </CircleIcon>
                        </div>
                ...
                <div className="px-4 py-5 flex flex-col gap-5 border rounded-lg">
                  ...
                  <div className="flex items-center gap-4">
                    <img
                      src="https://loremflickr.com/400/400"
                      className="h-[4rem] w-[4rem] rounded-lg object-cover"
                    />
                    <div>
                      <h1 className="font-semibold text-lg">
                        Senior Android Developer
