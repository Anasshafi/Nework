    ...
    <>
          ...
          >
            <SwiperSlide>
              <div className="flex flex-col gap-4 text-[#248489]">
                ...
                <p>
                  Learn how to build web applications from
                  <br className="hidden md:block" />
                  Scratch Level to Master Level
                </p>
                <div>
                  <Button
                    bg="bg-[#248489]"
            ...
            <SwiperSlide>
              <div className="flex flex-col gap-4 text-[#248489]">
                ...
                <p>
                  Learn how to build Android applications from
                  <br className="hidden md:block" />
                  Scratch Level to Master Level
                </p>
                <div>
      ...
      <div className="bg-[#FAFAFA] py-[2rem]">
        <div className="container flex items-center justify-start lg:justify-around gap-5 flex-wrap">
          <CoursesSpecs
            icon={<Svgs.Anytime />}
            title="Learn Anytime"
            desc="Learn and Repeat anytime you want"
          />
          <CoursesSpecs
            icon={<Svgs.Improve />}
            title="Improve Skills"
            desc="Online Courses to Improve Your Technical Skills "
          />
          <CoursesSpecs
            icon={<Svgs.Experience />}
            title="Experienced Instructo"
            desc="Learn from top Experienced Instructor"
          />
        </div>
      </div>
        ...
        <div className="bg-[#35424b] p-3 min-h-[16rem] bg-started started-bg bg-no-repeat">
          <div className="flex gap-6 justify-between flex-wrap h-full relative z-[2]">
            <div className="flex flex-col gap-3 p-[2rem] justify-center">
              <h1 className="text-white text-[2.4rem]">
                Join World's Leading Web & App Dev Community
              </h1>
              <p className="text-white/70">
                Millions of Web and App developers around the world showcase
                their portfolio work on Nework
              </p>
            </div>
      ...
      <div className="bg-[#FAFAFA]">
        <div className="container py-[5rem]">
          <h1 className="font-semibold text-xl mb-[1.2rem]">
            ...
            <SwiperSlide>
              <div className="bg-white p-[2rem] rounded flex flex-col justify-between gap-[2rem]">
                <p className="text-[#757575]">
                  Digistudi prepare people to carry out skills in the real
                  world. Keep up the good work. What I have learned in this
                  course, I will be able to apply in the real world.
                </p>
