  ...
  return (
    <>
        ...
        <div className="h-[34rem]">
          <div className="flex items-center gap-[5rem] h-full">
            <div className="flex flex-col gap-5 ml-[1rem] lg:ml-[6rem]">
              <h1 className="text-[2.8rem] text-[#333333] font-semibold tracking-[0.08rem]">
                Explore World's Leading
                <br className="hidden lg:block" />
                Web & App Portfolio
              </h1>
              <p className="text-sm text-[#666666]">
                Millions of Web and App developers around the world showcase
                <br className="hidden lg:block" />
                their portfolio work on Nework - the home to the world's best
                Web
                <br className="hidden lg:block" />
                and App professionals.
              </p>
            ...
            <div className="flex-1 h-full">
              <div className="relative w-full">
                <img
                  src={`${process.env.PUBLIC_URL}/assets/images/banner-bg-g.png`}
                  className="h-[34rem] absolute top-0 right-0"
                />
              </div>
            </div>
          </div>
      ...
      <section>
        <div className="py-[2rem] container mx-auto w-[86%]">
          <div className="flex lg:items-center lg:gap-[4rem] gap-4 lg:flex-row flex-col">
            <h2 className="font-bold text-[#333333] text-[2rem]">
              How It Works?
            </h2>
            <p className="text-[#666666] text-sm">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae in
              officiis cupiditate <br /> ratione rem, velit totam cumque
              voluptas quia provident nisi. Dolorum.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative">
        ...
        <img
          src={`${process.env.PUBLIC_URL}/assets/images/how-it-works.png`}
          className="absolute object-contain h-[12rem] right-0 top-1/2 z-[-1] lg:block hidden"
        />
      </section>
        ...
        <div className="container py-[2rem] pt-[5rem]">
          ...
          {HomeSection === "Wordpress" && (
            <div className="slide-in-bottom grid 2xl:grid-cols-4 xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 py-[3rem]">
              {jobPostings &&
                jobPostings.length > 0 &&
                jobPostings.map((data, idx) => {
                  return <HomeCard job={data} key={idx} />;
                })}
            </div>
          )}
      ...
      <section>
        <div className="container py-[2rem]">
          <div className="flex flex-col gap-5 text-center">
            <h1 className="text-[#333333] font-bold text-[2.1rem]">
            ...
            <div className="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-[1rem]">
              {[0, 1, 0, 0, 0, 0].map((ele) => {
                return (
                  <div className='rounded-lg bg-[url("https://images.unsplash.com/photo-1456926631375-92c8ce872def?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80")] min-h-[20rem] relative overflow-hidden rated_p'>
                    <div className="bg-[#000000A6] p-5 flex flex-col text-white h-full text-left gap-4 rated">
                      ...
                      <p className="text-sm">
                        ...
                        elit.ectetur adipisicing elit. Deleniti ut velit
                        voluptas, blanditiis illo, eaque sit oit, amet
                        consectetur adipisicing elit.ectetur adipisicing elit.
                        Deleniti ut velit voluptas, blanditiis illo, eaque sit
                        obcaecati laudantium vel aperiam debitis quaedipisicing
                        elit. Deleniti ut velit voluptas, blanditiis illo, eaque
                        sit obcaecati laudantium vel aperiam debitis quaerat?
                      </p>
        ...
        <div className="my-[2rem] container">
          ...
          <div className="flex flex-col gap-6 py-[2rem]">
            ...
            <div className="flex flex-col gap-2 flex-1">
              ...
              <textarea
                rows={7}
                className="resize-none w-full focus:border-[#248489] bg-[#F7F7F7] border border-transparent placeholder:text-[#999999] text-sm rounded-md outline-none px-4 py-2 transition-all"
      ...
      <section>
        <div className="my-[2rem] container">
          <h2 className="text-center font-semibold text-[2.4rem]">
            Our Latest Blogs
          </h2>
